    ...
    <script type="text/javascript" src="<?= ASSETS ?>mini/js/responsee.js"></script>
    <script type="text/javascript" src="<?= ASSETS ?>mini/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?= ASSETS ?>mini/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?= ASSETS ?>mini/js/template-scripts.js"></script> 
  </body>
</html>